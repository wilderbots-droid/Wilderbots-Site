...
const hasFirebaseConfig = requiredFirebaseKeys.every((key) => Boolean(process.env[key]))
...
export async function signInWithGooglePopup() {
  if (!auth) {
    const error = 'Google sign-in is not configured. Please set the required NEXT_PUBLIC_FIREBASE_* environment variables.'
    console.error(error)
